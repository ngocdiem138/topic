...
class AdminProjectBid extends Component {
  ...
  render() {
    ...
    return (
      ...
      <React.Fragment>
        ...
        {/* <div>fenil</div> */}
        {/* <Route path="/teacher/ProjectBid/table" exact component={TeacherProjectBidTable} /> */}
        {/* <Route path="/teacher/ProjectBid/form" exact component={() => <TeacherProjectBidForm onProjectBidSubmit={this.handleProjectBidSubmit} />} /> */}
  ...
  handleProjectBidSubmit = event => {
    ...
    axios
      .post(process.env.REACT_APP_API_URL + "/api/teacher/project-bid", body, {
        headers: {

...
import "./StudentProjectBidFormEdit.css";
import axios from "axios";
import { Form, Button, Col, Row } from "react-bootstrap";



class StudentProjectBidFormEdit extends Component {
  state = {
    status: '',
    portalsInfo: [],
  ...
  loadPortalsInfo = () => {
    axios
      .get(process.env.REACT_APP_API_URL + "/api/teacher/portal", {
        headers: {
...
export default StudentProjectBidFormEdit;
